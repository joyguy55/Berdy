...
export function setMovie(movie){
  return (dispatch) => {
     axios.get(`https://api.themoviedb.org/3/search/movie?api_key=0f0bbfb38d44aef5ee75cc44b80f0795&language=en-US&query=${movie}&page=1&include_adult=false`)
     .then((res)=>{
       dispatch({type:'SET_MOVIE', movie: [...res.data.results]})
     })
  }
}
